    ...
    internal partial class CineDetalleEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var codigoDeEtica = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            codigoDeEtica.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
            ...
            historia.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
            ...
            var misiones = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            misiones.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
            ...
            var valores = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            valores.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
