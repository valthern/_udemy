...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20241018195020_Inicial'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241018195359_DatosDePrueba'
)
BEGIN
    ...
    EXEC(N'INSERT INTO [Actores] ([Id], [Biografia], [FechaNacimiento], [Nombre])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Cines] ([Id], [Nombre], [Ubicacion])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Generos] ([Identificador], [Nombre])
    VALUES (1, N''Acción''),
    (2, N''Animación''),
    (3, N''Comedia''),
    (4, N''Ciencia ficción''),
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Peliculas] ([Id], [EnCartelera], [FechaEstreno], [PosterURL], [Titulo])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [CinesOfertas] ([Id], [CineId], [FechaFin], [FechaInicio], [PorcentajeDescuento])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [GeneroPelicula] ([GenerosIdentificador], [PeliculasId])
    VALUES (1, 1),
    (1, 3),
    (1, 4),
    (1, 5),
...
BEGIN
    ...
    EXEC(N'INSERT INTO [PeliculasActores] ([ActorId], [PeliculaId], [Orden], [Personaje])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [SalasDeCine] ([Id], [CineId], [Precio], [TipoSalaDeCine])
    VALUES (1, 1, 220.0, 1),
    (2, 1, 320.0, 2),
    (3, 2, 200.0, 1),
    (4, 2, 290.0, 2),
...
BEGIN
    ...
    EXEC(N'INSERT INTO [PeliculaSalaDeCine] ([PeliculasId], [SalasDeCineId])
    VALUES (5, 1),
    (5, 2),
    (5, 3),
    (5, 4),
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241029171421_GenerosBorradoSuave'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241029193052_Logs'
)
BEGIN
    CREATE TABLE [Logs] (
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241030155045_GeneroIndice'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241030190657_IndiceNombreFiltro'
)
BEGIN
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Generos_Nombre] ON [Generos] ([Nombre]) WHERE EstaBorrado = ''false''');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241030193749_EjemploConversion'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [SalasDeCine] SET [TipoSalaDeCine] = N''DosDimensiones''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [SalasDeCine] SET [TipoSalaDeCine] = N''TresDimensiones''
    WHERE [Id] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [SalasDeCine] SET [TipoSalaDeCine] = N''CXC''
    WHERE [Id] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241030232828_CampoMoneda'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [SalasDeCine] SET [Moneda] = N''''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241105152911_VistaConteoPeliculas'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241105165318_FechaCreacionGenero'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241105190759_FotoActor'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241105195116_CineIdNullable'
)
BEGIN
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_CinesOfertas_CineId] ON [CinesOfertas] ([CineId]) WHERE [CineId] IS NOT NULL');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241106151758_CampoElCine'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [CinesOfertas] SET [FechaFin] = ''2024-11-13'', [FechaInicio] = ''2024-11-06''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [CinesOfertas] SET [FechaFin] = ''2024-11-11'', [FechaInicio] = ''2024-11-06''
    WHERE [Id] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241106165024_EjemploPersona'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Personas] ([Id], [Nombre])
    VALUES (1, N''Felipe''),
    (2, N''Claudia'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Nombre') AND [object_id] = OBJECT_ID(N'[Personas]'))
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Mensajes] ([Id], [Contenido], [EmisorId], [ReceptorId])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241106224959_NoPodemosBorrarCineConSalasDeCine'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241107001117_CineDetalleTableSplitting'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241107190954_EjemploOwned'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [CinesOfertas] SET [FechaFin] = ''2024-11-14'', [FechaInicio] = ''2024-11-07''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [CinesOfertas] SET [FechaFin] = ''2024-11-12'', [FechaInicio] = ''2024-11-07''
    WHERE [Id] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241107234544_HerenciaTPH'
)
BEGIN
    CREATE TABLE [Pagos] (
        [Id] int NOT NULL IDENTITY,
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Pagos] ([Id], [FechaTransaccion], [Monto], [TipoPago], [Ultimos4Digitos])
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CorreoElectronico', N'FechaTransaccion', N'Monto', N'TipoPago') AND [object_id] = OBJECT_ID(N'[Pagos]'))
        SET IDENTITY_INSERT [Pagos] ON;
    EXEC(N'INSERT INTO [Pagos] ([Id], [CorreoElectronico], [FechaTransaccion], [Monto], [TipoPago])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241108161735_HerenciaTPT'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [CinesOfertas] SET [FechaFin] = ''2024-11-15'', [FechaInicio] = ''2024-11-08''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [CinesOfertas] SET [FechaFin] = ''2024-11-13'', [FechaInicio] = ''2024-11-08''
    WHERE [Id] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Productos] ([Id], [Nombre], [Precio])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Merchandising] ([Id], [DisponibleEnInventario], [EsColeccionable], [EsRopa], [Peso], [Volumen])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [PeliculasAlquilables] ([Id], [PeliculaId])
    VALUES (1, 1)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'PeliculaId') AND [object_id] = OBJECT_ID(N'[PeliculasAlquilables]'))
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241108183827_GeneroEjemplo'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Generos] SET [Ejemplo] = NULL
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241108184604_EjemploNuevaCarpeta'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241108191918_Primera'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241108192143_Segunda'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241108234309_RemoverColumnaEjemplo'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241109001717_ColumnaEjemplo'
)
BEGIN
    ALTER TABLE [Generos] ADD [Ejemplo] nvarchar(max) NULL;
END;
