...
public partial class EfcorePeliculasContext : DbContext
{
    public EfcorePeliculasContext()
    {
    }

    public EfcorePeliculasContext(DbContextOptions<EfcorePeliculasContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CinesOferta>(entity =>
        {
            ...
            entity.HasOne(d => d.Cine).WithOne(p => p.CinesOferta).HasForeignKey<CinesOferta>(d => d.CineId);
        });
        ...
        modelBuilder.Entity<Genero>(entity =>
        {
            ...
            entity.HasMany(d => d.Peliculas).WithMany(p => p.GenerosIdentificadors)
                .UsingEntity<Dictionary<string, object>>(
                    "GeneroPelicula",
                    r => r.HasOne<Pelicula>().WithMany().HasForeignKey("PeliculasId"),
                    l => l.HasOne<Genero>().WithMany().HasForeignKey("GenerosIdentificador"),
                    j =>
                    {
        ...
        modelBuilder.Entity<Merchandising>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithOne(p => p.Merchandising).HasForeignKey<Merchandising>(d => d.Id);
        });
        ...
        modelBuilder.Entity<Pelicula>(entity =>
        {
            ...
            entity.HasMany(d => d.SalasDeCines).WithMany(p => p.Peliculas)
                .UsingEntity<Dictionary<string, object>>(
                    "PeliculaSalaDeCine",
                    r => r.HasOne<SalasDeCine>().WithMany().HasForeignKey("SalasDeCineId"),
        ...
        modelBuilder.Entity<PeliculasAlquilable>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithOne(p => p.PeliculasAlquilable).HasForeignKey<PeliculasAlquilable>(d => d.Id);
        });
        ...
        modelBuilder.Entity<SalasDeCine>(entity =>
        {
            ...
            entity.HasOne(d => d.ElCineNavigation).WithMany(p => p.SalasDeCines)
